...
public class Script_RadioController_6 : MonoBehaviour {
    ...
    void playRadio()
    {
        if (audioIncrement < numberOfStations)
        {
            ...
            if (audioIncrement % 2 != 0 && audioIncrement < (numberOfStations - 4))//talk radio is on odd numbers starting from 1, last array elements are creepy
            {
